...
void draw_perry(const uint8_t x, const uint8_t y) {

  terminal_draw_rec(x, y, x + 30, y + 10, VGA_COLOR_CYAN);
  terminal_draw_rec(x + 3, 7, x + 7, 9, VGA_COLOR_BLACK);
  terminal_draw_rec(48, 7, 52, 9, VGA_COLOR_BLACK);
  terminal_draw_rec(26, 10, 54, 11, VGA_COLOR_BROWN);
