...
pgulong_t* palloc_single() {
  ...
  terminal_write_int(i * 0x1000, 16);
...
pgulong_t* palloc() {
  ...
  terminal_write_int((pgulong_t)(((uint32_t)&_kernel_end) - ((uint32_t)&_kernel_start)), 10);
