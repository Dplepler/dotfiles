...
#define CHECK_FREE_FRAME(bitmap, i) (bitmap[(uint32_t)i / BITS_IN_LONG] &   (1 << ((uint32_t)i % BITS_IN_BYTE)))
#define MARK_USED(bitmap, i)        (bitmap[(uint32_t)i / BITS_IN_LONG] |=  (1 << ((uint32_t)i % BITS_IN_BYTE)))
#define MARK_UNUSED(bitmap, i)      (bitmap[(uint32_t)i / BITS_IN_LONG] &= ~(1 << ((uint32_t)i % BITS_IN_BYTE)))
